...
const Tutorials = () => {
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center text-white">
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-white"
    >
      <div className="mb-8">
